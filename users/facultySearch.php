        ...
        if($_SERVER['REQUEST_METHOD'] === "POST"){
            ...
            if($filter == "name"){
                ...
                if($nameres->num_rows > 0){
                    ...
                    echo "<p>No Faculty Found with a Name: $search in the Department: $department</p>";
                }
            }
            ...
            if($filter == "email"){
                ...
                if($emailres->num_rows > 0){
                    ...
                    echo "<p>No Faculty Found with a Email: $search in the Department: $department</p>";
                }
            }
            ...
            if($filter == "Username"){
                ...
                if($usernameres->num_rows > 0){
                    ...
                    echo "<p>No Faculty Found with a Username: $search in the Department: $department</p>";
                }
            }
        }   
    ?>